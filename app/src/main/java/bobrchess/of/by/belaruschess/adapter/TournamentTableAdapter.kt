...
class TournamentTableAdapter(onUserClickListener: OnUserClickListener) : RecyclerView.Adapter<TournamentTableAdapter.UserViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserViewHolder {
        val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.tournament_table_user_item_view, parent, false)
    ...
    inner class UserViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val user_count_points_text_view: TextView
        private val user_place_text_view: TextView
        ...
        init {
            ...
            user_count_points_text_view = itemView.findViewById(R.id.user_count_points_text_view)
            user_place_text_view = itemView.findViewById(R.id.user_place_text_view)
