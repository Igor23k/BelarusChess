...
class AnnualEventInstanceFragment : EventInstanceFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (arguments != null) {
            ...
            EventHandler.getEventToEventIndex(eventID)?.let { annualEvent ->
               /* if (annualEvent is AnnualEvent) {
                    ...
                    if (annualEvent.hasStartYear) {
                        ...
                        editDate.text = EventDate.getLocalizedDayAndMonthString(this.eventStartDate)
                    }
            ...
            editDate.hint = EventDate.getLocalizedDayMonthYearString(this.eventStartDate)
        }
        ...
        switchIsYearGiven.setOnCheckedChangeListener { _, isChecked ->
            if (editDate.text.isNotBlank()) {
                ...
                if (isChecked) {
                    ...
                    editDate.text = EventDate.getLocalizedDayMonthYearString(this.eventStartDate)
                    //year is not given
                } else {
                    editDate.text = EventDate.getLocalizedDayAndMonthString(this.eventStartDate)
                }
                ...
                if (isChecked) {
                    ...
                    editDate.hint = EventDate.getLocalizedDayAndMonthString(this.eventStartDate)
                }
            }
        }
    }
